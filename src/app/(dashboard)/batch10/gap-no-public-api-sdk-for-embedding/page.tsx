...
// Batch 10 page: "No public API + SDK for embedding agents in customer apps" (nonai-gap) — luranAi
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-public-api-sdk-for-embedding";
const LABEL = "No public API + SDK for embedding agents in customer apps";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-public-api-sdk-for-embedding";

export default function NoPublicApiSdkForEmbeddingPage() {
