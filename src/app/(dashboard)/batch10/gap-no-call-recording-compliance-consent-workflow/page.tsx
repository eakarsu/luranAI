...
// Batch 10 page: "No call-recording compliance / consent workflow per region" (nonai-gap) — luranAi
'use client';
...
const API_PATH = "/api/gap-no-call-recording-compliance-consent-workflow";

export default function NoCallRecordingComplianceConsentWorkflowPage() {
