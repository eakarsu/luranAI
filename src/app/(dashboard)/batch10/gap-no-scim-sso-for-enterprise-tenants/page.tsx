...
// Batch 10 page: "No SCIM / SSO for enterprise tenants" (nonai-gap) — luranAi
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-scim-sso-for-enterprise-tenants";
const LABEL = "No SCIM / SSO for enterprise tenants";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-scim-sso-for-enterprise-tenants";

export default function NoScimSsoForEnterpriseTenantsPage() {
